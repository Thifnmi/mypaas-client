...
import (
	...
	"github.com/thifnmi/mypaas/provision/nodecontainer"
)
...
func (c *NodeContainerList) Run(context *cmd.Context, client *cmd.Client) error {
	...
	var all []nodecontainer.NodeContainerConfigGroup
...
func (c *NodeContainerInfo) Run(context *cmd.Context, client *cmd.Client) error {
	...
	var poolConfigs map[string]nodecontainer.NodeContainerConfig
